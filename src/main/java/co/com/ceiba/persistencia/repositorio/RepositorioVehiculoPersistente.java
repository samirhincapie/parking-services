...
public class RepositorioVehiculoPersistente implements RepositorioRegistro {
	...
	public RepositorioVehiculoPersistente(EntityManager entityManager, RepositorioVehiculo repositorioVehiculo) {
